...
class API:
    def __init__(self, file="api_key/key.json", worldId=0) -> None:
        ...
        self.api_key = api_data["x-api-key"]
        self.uid = api_data["userId"]
        self.tid = api_data["teamId"]
        self.wid = worldId
    ...
    def getLocation(self):
        ...
        conn.request("GET", "/aip2pgaming/api/rl/gw.php?type=location&teamId=1358", payload, headers)
    ...
    def get_runs(self):
        ...
        conn.request("GET", "/aip2pgaming/api/rl/score.php?type=runs&teamId=1358&count=10", payload, headers)
        res = conn.getresponse()
        data = res.read()
        print(data.decode("utf-8"))
    ...
    def get_score(self):
        ...
        conn.request("GET", "/aip2pgaming/api/rl/score.php?type=score&teamId=1358", payload, headers)
        res = conn.getresponse()
        data = res.read()
        print(data.decode("utf-8"))

    def makeMove(self, move='N'):
        conn = http.client.HTTPSConnection("www.notexponential.com")
        dataList = []
        boundary = 'wL36Yn8afVp8Ag7AmP8qZ0SA4n1v9T'
        dataList.append(encode('--' + boundary))
